...
function newFurniture() {
	var newItem = new Furniture(document.getElementById("furnitureName").value, 100, 100, feetToPixels(parseFloat(document.getElementById("furnitureWidth").value)), feetToPixels(parseFloat(document.getElementById("furnitureHeight").value)));
